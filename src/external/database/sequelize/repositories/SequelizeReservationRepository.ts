...
export default class SequelizeReservationRepository implements ReservationRepository {
  async getByEmployeeID(id: string, pageNumber: number, pageSize: number): Promise<Reservation[]> {
