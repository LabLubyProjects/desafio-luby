...
export default class UpdateEmployeeUseCase extends BaseEmployeeRelatedUseCase {
  async handle(
    ...
    if (inputUpdateEmployee.biography)
    ...
    const outputEmployee: OutputEmployee = {
      id: updatedEmployee.id,
      cpf: updatedEmployee.cpf,
      name: updatedEmployee.name,
      email: updatedEmployee.email,
      biography: updatedEmployee.biography,
      type: translateEmployeeType(updatedEmployee.type),
    };
