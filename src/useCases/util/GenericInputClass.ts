import { InputCreateEmployee, InputDeleteEmployee, InputGetAllEmployees, InputGetEmployeeByID, InputGetEmployeeWithRelations, InputLoginEmployee } from "../employeeRelated/EmployeeIO";
