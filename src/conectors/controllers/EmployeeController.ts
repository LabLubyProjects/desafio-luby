...
import {
  InputCreateEmployee,
  InputDeleteEmployee,
  InputGetAllEmployees,
  InputGetEmployeeWithRelations,
  InputLoginEmployee,
  InputUpdateEmployee,
  OutputEmployee,
  OutputGetEmployeeWithRelations,
} from '@src/useCases/employeeRelated/EmployeeIO';
...
export default class EmployeeController extends BaseController {
  static async login(
    ...
    const user = await new LoginEmployeeUseCase(employeeRepository).handle(
      input
    );
  ...
  static async createEmployee(
    ...
    const input = new InputCreateEmployee(
      cpf,
      name,
      email,
      biography,
    ...
    return {
      id: await new CreateEmployeeUseCase(employeeRepository).handle(input),
    };
  }
  ...
  static async updateEmployee(
    ...
    const input = new InputUpdateEmployee(
      sourceID,
      id,
      name,
      email,
  ...
  static async getAllEmployees(
    ...
    else input = new InputGetAllEmployees();
  ...
  static async getEmployeeWithRelations(
    ...
    return new GetEmployeeWithRelationsUseCase(employeeRepository).handle(
      input
    );
  }
